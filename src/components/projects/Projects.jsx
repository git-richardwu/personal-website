            ...
            <div className="cardBodyP">
                ...
                <div className="column">
                    <div id="virtualDesktop" className="projectCard">
                       ...
                       <div className="externalLinks">
                            <a href="https://a9-sleepers-demo.herokuapp.com/" rel="noopener noreferrer" target="_blank" className="icon-styleP"><HiExternalLink size={35}/></a>
                ...
                <div className="column">  
                    <div id="foodForThought" className="projectCard">
                        ...
                        <hr className="cardDivider"></hr>
                        <div className="externalLinks">
                            <a href="https://webdev.cse.buffalo.edu/hci/diamond/" rel="noopener noreferrer" target="_blank" className="icon-styleP"><HiExternalLink size={35}/></a>
